  ...
  return (
    <section id="about" className="scroll-mt-24">
      <h2 className="text-3xl md:text-4xl font-bold mb-12 text-text-main flex items-center gap-4">
        <span className="text-accent-primary font-mono text-2xl">01.</span> Who I Am
      </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <div className="border-l-2 border-accent-primary pl-4 py-2 mt-8">
